...
export class StockPrice {
  ...
  @Element() el: HTMLElement; // NOT in use
  ...
  onFetchStockPrice(event: Event) {
    ...
    // const stockSymbol = this.el.shadowRoot.querySelector<HTMLInputElement>('#stock-symbol').value;
    this.stockSymbol = this.stockInput.value;
    // const stockSymbol = this.stockInput.value;
    // this.fetchStockPrice(stockSymbol);
  }

  /*** execute right before the component is about to load ***/
  componentWillLoad() {
  ...
  /*** will fire right before it will rerender (when a value of state changed) ***/
  componentWillUpdate() {
    console.log('componentWillUpdate');
  }

  /*** fire after rendering ***/
  componentDidUpdate() {
  ...
  render() {
    ...
    if (this.loading) {
      dataContent = <awc-spinner></awc-spinner>;
    }
    return [
